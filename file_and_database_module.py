...
class FileAndDatabaseObject:
    ...
    def result_score_single_player(self,name,difficulty,win,loss,tie,game_variable_object):
        ...
        if win:
            ...
            if (difficulty == game_variable_object.translate_difficulty_to_recursion_levels['Hard']):
                self.instance_database[the_single_player][4] += 6
            elif (difficulty == game_variable_object.translate_difficulty_to_recursion_levels['Medium']):
