...
class SinglePlayer:
    ...
    def person_goes_first(self,name,difficulty,artificial_intelligence_object,\
        ...
        while nobody_has_won[0]:
            ...
            nobody_has_won = artificial_intelligence_object.no_wins(game_tracking_variable_object.instance_current_status_of_board_pieces,\
                                                                    checker_object)
            all_filled = checker_object.all_filled_up(game_tracking_variable_object.instance_array_of_available_spots)
...
class Multiplayer:
    ...
    """
    def run_game(self,name,second_name,checker_object,game_tracking_variable_object,\
        ...
        while (nobody_has_won):
            ...
            coordinates = input_object.nothing_there(game_tracking_variable_object.instance_turn_of_x_char_or_not,game_tracking_variable_object,\
                                                     True)
            print_object.change_game_state(game_tracking_variable_object,coordinates)
            nobody_has_won = checker_object.no_one_wins(print_object,game_tracking_variable_object)
    ...
    def Tic_Tac_Toe_Interactive_Version(self,name,second_name,checker_object,\
                                        game_tracking_variable_object,print_object,input_object):
        """
        ...
        while continue_playing:
            ...
            if continue_playing:
                checker_object.reset_the_board(game_tracking_variable_object)
